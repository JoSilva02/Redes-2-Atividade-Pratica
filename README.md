...
*   Upload de arquivos do cliente para servidor

*   Download de arquivos do servidor para cliente
...
*   Servidor gerencia o estado do jogo

*   Clientes alternam jogadas
...
*   Mensagens offline (armazenamento no servidor)
